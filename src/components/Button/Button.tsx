...
const useStyles = makeStyles(theme => ({
  root: ({ highlighted, large, flat, text, isDarkMode, fullWidth }: StyleProps) => ({
    ...
    color: text ? theme.palette.text.secondary : (highlighted ? 'white' : 'white'), 
    ...
    '&:hover': {
      color: text ? theme.palette.text.primary : (highlighted ? 'white' : 'white'), // Texto en blanco al pasar el ratón
      background: text ? 'none' : (highlighted
        ? theme.bgGradient.main
        : flat
